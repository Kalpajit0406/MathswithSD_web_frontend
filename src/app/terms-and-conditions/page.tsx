      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-8 lg:p-12 shadow-sm flex flex-col gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-3 text-xs text-slate-505 font-semibold">
              <Calendar size={14} />
          ...
          <div className="flex flex-col gap-6 text-sm text-slate-600 leading-relaxed">
            ...
            {/* User Accounts */}
            <section className="flex flex-col gap-2">
              <h3 className="text-base font-bold text-slate-900 uppercase tracking-wide">2. User Accounts & Security</h3>
              <p>
            ...
            <section className="flex flex-col gap-2">
              <h3 className="text-base font-bold text-slate-900 uppercase tracking-wide">5. Disclaimer & Limitation of Liability</h3>
              <p>
            ...
            {/* Termination */}
            <section className="flex flex-col gap-2">
              <h3 className="text-base font-bold text-slate-900 uppercase tracking-wide">6. Account Suspension & Termination</h3>
              <p>
            ...
            <section className="flex flex-col gap-4 mt-4 border-t border-slate-100 pt-6">
              <h3 className="text-base font-bold text-slate-900 uppercase tracking-wide">7. Contact Information</h3>
              <p>

          ...
          {status === "success" ? (
            <div className="text-center py-8 flex flex-col items-center gap-4">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 max-w-md leading-relaxed">
                Thank you. We have received your data removal request for <strong className="text-slate-950 dark:text-white">{formState.email}</strong>.
              </p>
              ...
              <div className="mt-8 flex flex-wrap gap-4 justify-center">
                <Link href="/" className="px-6 py-3 bg-slate-900 hover:bg-slate-800 dark:bg-slate-100 dark:hover:bg-slate-200 text-white dark:text-slate-900 text-sm font-bold rounded-xl transition-all shadow-md">
                  Return Home
                </Link>
            ...
            <>
              ...
              <div className="flex gap-3 p-5 bg-slate-50 dark:bg-slate-800/20 border-l-4 border-slate-700 dark:border-slate-400 rounded-r-2xl text-slate-800 dark:text-slate-200">
                <ShieldCheck size={24} className="flex-shrink-0 text-slate-700 dark:text-slate-300" />
                ...
                <form name="data-removal" onSubmit={handleSubmit} className="flex flex-col gap-5">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      className="w-full bg-[#f8fafc] dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-slate-400 dark:focus:border-slate-600 transition-all"
                    />
                  </div>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#f8fafc] dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-slate-400 dark:focus:border-slate-600 transition-all resize-y min-h-[100px]"
                    />
                  </div>
                  ...
                  <div className="flex items-start gap-3 mt-2 cursor-pointer">
                    <input
                      ...
                      className="mt-1 h-4 w-4 cursor-pointer text-slate-800 dark:text-slate-200 rounded border-slate-300 focus:ring-slate-500"
                    />
                    <label htmlFor="consent" className="text-xs text-slate-600 dark:text-slate-450 font-medium leading-relaxed select-none cursor-pointer">
                  ...
                  <div className="mt-4">
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-6 py-3.5 bg-slate-900 hover:bg-slate-800 dark:bg-slate-100 dark:hover:bg-slate-200 text-white dark:text-slate-900 text-sm font-bold rounded-xl transition-all shadow-md disabled:opacity-50"
                    >
              ...
              <section className="mt-6 border-t border-slate-100 dark:border-slate-800/80 pt-6">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-2 leading-relaxed">
                  If you prefer, you can send your request directly via email to <a href="mailto:kalpajitbepary@gmail.com?subject=Data%20Removal%20Request" className="text-slate-900 dark:text-white hover:underline font-semibold">kalpajitbepary@gmail.com</a>. Please include your registered name, email address, and mobile number.
                </p>
              </section>
            </>
          )}

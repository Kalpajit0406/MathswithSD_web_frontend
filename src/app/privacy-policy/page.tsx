      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-8 lg:p-12 shadow-sm flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-6 text-sm text-slate-600 leading-relaxed">
            ...
            <section className="flex flex-col gap-2">
              <h3 className="text-base font-bold text-slate-900 uppercase tracking-wide">2. Information We Collect</h3>
              <p>
            ...
            <section className="flex flex-col gap-2">
              <h3 className="text-base font-bold text-slate-900 uppercase tracking-wide">3. How We Use Information</h3>
              <p>
            ...
            <section className="flex flex-col gap-2">
              <h3 className="text-base font-bold text-slate-900 uppercase tracking-wide">4. Third-Party Services</h3>
              <p>
            ...
            {/* Data Security */}
            <section className="flex flex-col gap-2">
              <h3 className="text-base font-bold text-slate-900 uppercase tracking-wide">5. Data Security</h3>
              <p>
            ...
            <section className="flex flex-col gap-2">
              <h3 className="text-base font-bold text-slate-900 uppercase tracking-wide">7. Changes to This Policy</h3>
              <p>
            ...
            {/* Contact Information */}
            <section className="flex flex-col gap-4 mt-4 border-t border-slate-100 pt-6">
              <h3 className="text-base font-bold text-slate-900 uppercase tracking-wide">8. Contact Information</h3>
              <p>

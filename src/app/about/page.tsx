    ...
    <div className="relative py-16 lg:py-24 bg-slate-50 dark:bg-slate-950 min-h-screen">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col gap-16">
          ...
          {/* Section 1: Intro */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-900 rounded-3xl p-8 shadow-sm">
            <div className="flex flex-col gap-4">
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white">What is MathsWithSD?</h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-950 flex flex-col items-center text-center gap-2">
                <BookOpen className="text-violet-500" size={24} />
                <span className="text-xs font-bold dark:text-white">Structured Practice</span>
              </div>
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-950 flex flex-col items-center text-center gap-2">
                <Award className="text-cyan-500" size={24} />
                <span className="text-xs font-bold dark:text-white">Live Leaderboards</span>
              </div>
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-950 flex flex-col items-center text-center gap-2">
                <Shield className="text-emerald-500" size={24} />
                <span className="text-xs font-bold dark:text-white">Kiosk Shield Anti-Cheat</span>
              </div>
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-950 flex flex-col items-center text-center gap-2">
                <Users className="text-amber-500" size={24} />
                <span className="text-xs font-bold dark:text-white">Cohort Optimization</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col gap-4 p-8 rounded-3xl bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-900 shadow-sm">
          ...
          <div className="flex flex-col gap-6 p-8 rounded-3xl bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-900 shadow-sm">
            <h3 className="text-2xl font-bold text-slate-900 dark:text-white text-center">Our Educational Philosophy</h3>
            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed max-w-3xl mx-auto text-center">

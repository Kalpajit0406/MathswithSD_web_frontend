          ...
          <div className="md:col-span-7 flex flex-col gap-6">
            <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-1.5 text-xs text-slate-500">
                <div className="flex justify-between border-b border-slate-100 pb-2">
                  <span>Version:</span>
                  <span className="font-bold text-slate-800">v2.1.0-release</span>
                </div>
                ...
                <div className="flex justify-between pb-1 pt-2">
                  <span>Developer:</span>
                  <span className="font-bold text-slate-800">Kalpajit Bepary</span>
                </div>
              </div>
            ...
            <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm flex flex-col gap-6">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-bold text-slate-900">Required Permissions</h3>
              </div>
              <div className="flex flex-col gap-4">
                {permissions.map((p, i) => (
                  <div key={i} className="flex flex-col gap-1 text-xs">
                    <span className="font-bold text-slate-800">{p.label}</span>
                    <span className="text-slate-500 leading-normal">{p.desc}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="md:col-span-5 flex flex-col gap-6">
            ...
            <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm flex flex-col gap-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-bold text-slate-900">System Requirements</h3>
              </div>
              <div className="flex flex-col gap-4 text-xs">
                {requirements.map((req, i) => (
                  <div key={i} className="flex flex-col gap-0.5 border-b border-slate-100 pb-2 last:border-0 last:pb-0">
                    <span className="text-slate-400">{req.label}</span>
                    <span className="font-bold text-slate-850 leading-normal">{req.val}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* Highlights Card */}
            <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm flex flex-col gap-4">
              <h3 className="text-md font-bold text-slate-900">Release Highlights</h3>
